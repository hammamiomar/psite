...
This experiment fed directly into [Latent Dance](https://github.com/hammamiomar/latent-dance) — my real-time music visualizer. If you can train interpretable features on audio, you can potentially do audio-to-audio steering, or use audio features to drive visual generation.
