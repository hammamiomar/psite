...
[Project code: Latent Dance](https://github.com/hammamiomar/latent-dance)
...
(If you're curious about SAE features more broadly, Sangwu Lee's [Gazing in the Latent Space](https://re-n-y.github.io/devlog/rambling/sae/) is a good explainer, and tools like [fluxlens](https://fluxlens.vercel.app/) and Gytis's [Feature Lab](https://www.featurelab.xyz/) let you browse features interactively.)
...
- **Sangwu Lee — [Gazing in the Latent Space with Sparse Autoencoders](https://re-n-y.github.io/devlog/rambling/sae/)** and **[fluxlens](https://fluxlens.vercel.app/)** — Recommended reading on SAE features and a nice interactive browser, not used directly in this project.
