...
If we could steer through that, we wouldn't just be navigating SAE features in a diffusion model. We'd be navigating how a vision model understands the visual world — and doing data vis for that. That's where I want this to go.
