...
Directly mapping audio amplitude to visual intensity is mechanical and jittery. The bridge sits between audio features and SAE steering, adding weight and bounce to what would otherwise be jittery amplitude mapping.
...
I decided what to build and how it should feel. Claude helped me build it fast and clean.
